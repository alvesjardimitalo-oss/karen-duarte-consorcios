...
export default async function ClientesPage() {
  ...
  const { data: accessRequests } = isAdmin ? await supabase.from('client_access_requests').select('id,phone,requested_at,clients(name)').eq('status','PENDENTE').order('requested_at',{ascending:true}) : { data: [] as any[] };
