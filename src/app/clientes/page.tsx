...
export default async function ClientesPage({ searchParams }:{ searchParams:Promise<{erro?:string;cadastrado?:string}> }) {
  ...
  return <><StaffNav profile={profile} active="clientes"/><main className="clients-page with-app-nav"><div className="clients-wrap">
    ...
    {params.erro&&<div className="form-error" role="alert">{params.erro}</div>}
    {params.cadastrado==='1'&&<div className="form-success" role="status">Cliente cadastrado com sucesso.</div>}
